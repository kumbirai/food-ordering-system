package com.kumbirai.udemy.food.ordering.kafka.consumer.config;

import com.kumbirai.udemy.food.ordering.kafka.config.data.KafkaConfigData;
import com.kumbirai.udemy.food.ordering.kafka.config.data.KafkaConsumerConfigData;
