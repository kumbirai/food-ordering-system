    ...
    public void receive(@Payload List<RestaurantApprovalRequestAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalRequestAvroModel ->
        {
            try {
                ...
                if (sqlException != null && sqlException.getSQLState() != null && PSQLState.UNIQUE_VIOLATION.getState()
                    ...
                    throw new RestaurantApplicationServiceException("Throwing DataAccessException in" + " RestaurantApprovalRequestKafkaListener: " + e.getMessage(),
                            e);
                }
